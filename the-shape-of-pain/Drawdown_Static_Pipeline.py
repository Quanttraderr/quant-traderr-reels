...
RUN
    python Drawdown_Static_Pipeline.py
    -> Drawdown_Static.png  (3240x5760; 10.8x19.2in at 300 DPI)
"""
import os

from Drawdown_Reel_Pipeline import (CONFIG, BASE_DIR, fetch, compute,
                                        validate, prepare_geometry,
                                        render_frame, log)

STATIC = {"W": 3240, "H": 5760, "DPI": 300, "ELEV": 10, "AZIM": -58}
...
if __name__ == "__main__":
    render_static(os.path.join(BASE_DIR, "Drawdown_Static.png"))
